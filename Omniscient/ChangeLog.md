...
### New Features
* Added Analyzers: a way of scripting advanced analyses into Omniscient
* Created a declarations system that accomodates specific detection system-relevant declarations
* Events generated by other types of Event Generators can be added to Manual Events
* Added JSON Instruments
* Added default csv file extension when configuring CSV Instruments
* General improvements in viewing spectra
